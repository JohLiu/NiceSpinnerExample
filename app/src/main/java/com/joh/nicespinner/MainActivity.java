...
import com.joh.library.NiceSpinner;
import com.joh.library.OnSpinnerItemSelectedListener;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void setupTintedWithCustomClass() {
        ...
        people.add(new Person("Bruce2", "Banner"));
        people.add(new Person("Bruce3", "Banner"));
        people.add(new Person("Bruce4", "Banner"));
        people.add(new Person("Bruce5", "Banner"));
